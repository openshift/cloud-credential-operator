...
// NewReconciler will return a reconciler for handling EquinixMetal cloud cred secrets.
...
func Add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = secretutils.WatchCCOConfig(c, types.NamespacedName{
		...
		Name:      constants.EquinixMetalCloudCredSecretName,
	})
	if err != nil {
		return err
	}
...
func cloudCredSecretObjectCheck(secret metav1.Object) bool {
	return secret.GetNamespace() == constants.CloudCredSecretNamespace && secret.GetName() == constants.EquinixMetalCloudCredSecretName
}
