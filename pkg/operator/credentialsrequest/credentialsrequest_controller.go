...
const (
	...
	// Hack for 4.5 to get us a status update when we don't have a cred request to reconcile.
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	mapFn := handler.ToRequestsFunc(
		func(a handler.MapObject) []reconcile.Request {
			...
			// Hack for 4.5, reconcile a fake cred request we're watching for in the Reconcile loop, intended to be
