...
//
//	mockgen -source=./clients.go -destination=./mock/client_generated.go -package=mock
//
...
func (mr *MockAppClientMockRecorder) Delete(ctx, applicationObjectID any) *gomock.Call {
...
func (mr *MockAppClientMockRecorder) List(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResourceGroupsClientMockRecorder) BeginDelete(ctx, resourceGroupName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResourceGroupsClientMockRecorder) CreateOrUpdate(ctx, resourceGroupName, parameters, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResourceGroupsClientMockRecorder) Get(ctx, resourceGroupName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountsClientMockRecorder) BeginCreate(ctx, resourceGroupName, accountName, parameters, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockAccountsClientMockRecorder) Delete(ctx, resourceGroupName, accountName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountsClientMockRecorder) ListKeys(ctx, resourceGroupName, accountName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountsClientMockRecorder) NewListByResourceGroupPager(resourceGroupName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountsClientMockRecorder) NewListPager(options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountsClientMockRecorder) Update(ctx, resourceGroupName, accountName, parameters, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlobContainersClientMockRecorder) Create(ctx, resourceGroupName, accountName, containerName, blobContainer, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockBlobContainersClientMockRecorder) Get(ctx, resourceGroupName, accountName, containerName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAZBlobClientMockRecorder) UploadBuffer(ctx, containerName, blobName, buffer, o any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockRoleDefinitionsClientMockRecorder) CreateOrUpdate(ctx, scope, roleDefinitionID, roleDefinition, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockRoleDefinitionsClientMockRecorder) Delete(ctx, scope, roleDefinitionID, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRoleDefinitionsClientMockRecorder) GetByID(ctx, roleDefinitionID, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockRoleAssignmentsClientMockRecorder) Create(ctx, scope, roleAssignmentName, parameters, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockRoleAssignmentsClientMockRecorder) Delete(ctx, scope, roleAssignmentName, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRoleAssignmentsClientMockRecorder) NewListForScopePager(scope, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMockablePollerMockRecorder[T]) Poll(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMockablePollerMockRecorder[T]) PollUntilDone(ctx, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMockablePollerMockRecorder[T]) Result(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
