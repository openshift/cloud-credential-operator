...
func (m *EntitlementManagementResourceRequestsItemResourceScopesItemResourceRequestBuilder) Refresh() *EntitlementManagementResourceRequestsItemResourceScopesItemResourceRefreshRequestBuilder {
	return NewEntitlementManagementResourceRequestsItemResourceScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
