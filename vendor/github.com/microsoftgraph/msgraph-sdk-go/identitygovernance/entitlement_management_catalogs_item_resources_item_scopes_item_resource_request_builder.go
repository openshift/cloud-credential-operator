...
func (m *EntitlementManagementCatalogsItemResourcesItemScopesItemResourceRequestBuilder) Refresh() *EntitlementManagementCatalogsItemResourcesItemScopesItemResourceRefreshRequestBuilder {
	return NewEntitlementManagementCatalogsItemResourcesItemScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
