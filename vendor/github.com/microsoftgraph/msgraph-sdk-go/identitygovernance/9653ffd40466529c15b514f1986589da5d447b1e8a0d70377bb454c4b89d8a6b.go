...
// returns a *EntitlementManagementResourceRequestsItemResourceRolesItemResourceScopesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceRequestsItemResourceRolesItemResourceScopesItemResourceRequestBuilder) Refresh() *EntitlementManagementResourceRequestsItemResourceRolesItemResourceScopesItemResourceRefreshRequestBuilder {
	return NewEntitlementManagementResourceRequestsItemResourceRolesItemResourceScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
