...
func (m *EntitlementManagementCatalogsItemResourcesItemScopesItemResourceRolesItemResourceRequestBuilder) Refresh() *EntitlementManagementCatalogsItemResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilder {
	return NewEntitlementManagementCatalogsItemResourcesItemScopesItemResourceRolesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
