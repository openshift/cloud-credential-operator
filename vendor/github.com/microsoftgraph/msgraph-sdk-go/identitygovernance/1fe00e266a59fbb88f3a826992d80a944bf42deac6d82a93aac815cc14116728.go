...
// returns a *EntitlementManagementResourceEnvironmentsItemResourcesItemScopesItemResourceRefreshRequestBuilder when successful
func (m *EntitlementManagementResourceEnvironmentsItemResourcesItemScopesItemResourceRequestBuilder) Refresh() *EntitlementManagementResourceEnvironmentsItemResourcesItemScopesItemResourceRefreshRequestBuilder {
	return NewEntitlementManagementResourceEnvironmentsItemResourcesItemScopesItemResourceRefreshRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
