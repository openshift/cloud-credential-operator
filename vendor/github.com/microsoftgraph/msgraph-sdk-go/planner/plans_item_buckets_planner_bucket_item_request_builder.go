...
func (m *PlansItemBucketsPlannerBucketItemRequestBuilder) WithUrl(rawUrl string) *PlansItemBucketsPlannerBucketItemRequestBuilder {
	return NewPlansItemBucketsPlannerBucketItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter)
}
