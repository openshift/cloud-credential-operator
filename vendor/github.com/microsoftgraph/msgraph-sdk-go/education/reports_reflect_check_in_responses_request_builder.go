...
// [Find more info here]
//
// [Find more info here]: https://learn.microsoft.com/graph/api/reportsroot-list-reflectcheckinresponses?view=graph-rest-1.0
func (m *ReportsReflectCheckInResponsesRequestBuilder) Get(ctx context.Context, requestConfiguration *ReportsReflectCheckInResponsesRequestBuilderGetRequestConfiguration) (iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReflectCheckInResponseCollectionResponseable, error) {
	...
	res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateReflectCheckInResponseCollectionResponseFromDiscriminatorValue, errorMapping)
	if err != nil {
		return nil, err
	}
	if res == nil {
	...
	return res.(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReflectCheckInResponseCollectionResponseable), nil
}
...
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *ReportsReflectCheckInResponsesRequestBuilder) Post(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReflectCheckInResponseable, requestConfiguration *ReportsReflectCheckInResponsesRequestBuilderPostRequestConfiguration) (iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReflectCheckInResponseable, error) {
...
// returns a *RequestInformation when successful
func (m *ReportsReflectCheckInResponsesRequestBuilder) ToPostRequestInformation(ctx context.Context, body iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.ReflectCheckInResponseable, requestConfiguration *ReportsReflectCheckInResponsesRequestBuilderPostRequestConfiguration) (*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
