...
// MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder provides operations to manage the contentVersions property of the microsoft.graph.mobileLobApp entity.
...
// MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderGetRequestConfiguration struct {
	// Request headers
	Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
	// Request options
	Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
	// Request query parameters
	QueryParameters *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderGetQueryParameters
}

// MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderPostRequestConfiguration struct {
	// Request headers
	Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
	// Request options
	Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
func (m *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder) ByMobileAppContentId(mobileAppContentId string) *MobileAppsItemGraphWindowsAppXContentVersionsMobileAppContentItemRequestBuilder {
...
// NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderInternal instantiates a new MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder and sets the default values.
func NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder {
...
// NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder instantiates a new MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder and sets the default values.
func NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder {
	urlParams := make(map[string]string)
	urlParams["request-raw-url"] = rawUrl
	return NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder) WithUrl(rawUrl string) *MobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder {
	return NewMobileAppsItemGraphWindowsAppXContentVersionsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter)
}
