...
func (m *PersonType) GetClass() *string {
	val, err := m.GetBackingStore().Get("class")
	if err != nil {
		panic(err)
	}
	if val != nil {
...
func (m *PersonType) GetSubclass() *string {
	val, err := m.GetBackingStore().Get("subclass")
	if err != nil {
		panic(err)
	}
	if val != nil {
...
func (m *PersonType) SetClass(value *string) {
	err := m.GetBackingStore().Set("class", value)
	if err != nil {
		panic(err)
	}
}
...
func (m *PersonType) SetSubclass(value *string) {
	err := m.GetBackingStore().Set("subclass", value)
	if err != nil {
		panic(err)
	}
}
