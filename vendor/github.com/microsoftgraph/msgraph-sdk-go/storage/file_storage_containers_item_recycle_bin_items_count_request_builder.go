...
func NewFileStorageContainersItemRecycleBinItemsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *FileStorageContainersItemRecycleBinItemsCountRequestBuilder {
	m := &FileStorageContainersItemRecycleBinItemsCountRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/recycleBin/items/$count{?%24filter,%24search}", pathParameters),
	}
	return m
}
...
func NewFileStorageContainersItemRecycleBinItemsCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *FileStorageContainersItemRecycleBinItemsCountRequestBuilder {
	...
	return NewFileStorageContainersItemRecycleBinItemsCountRequestBuilderInternal(urlParams, requestAdapter)
}

// Get get the number of the resource
// returns a *int32 when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
func (m *FileStorageContainersItemRecycleBinItemsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *FileStorageContainersItemRecycleBinItemsCountRequestBuilderGetRequestConfiguration) (*int32, error) {
...
func (m *FileStorageContainersItemRecycleBinItemsCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FileStorageContainersItemRecycleBinItemsCountRequestBuilderGetRequestConfiguration) (*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *FileStorageContainersItemRecycleBinItemsCountRequestBuilder) WithUrl(rawUrl string) *FileStorageContainersItemRecycleBinItemsCountRequestBuilder {
	return NewFileStorageContainersItemRecycleBinItemsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter)
}
