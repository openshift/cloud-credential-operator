...
// returns a *string when successful
func (m *SendActivityNotificationToRecipientsPostRequestBody) GetIconId() *string {
...
func (m *SendActivityNotificationToRecipientsPostRequestBody) SetIconId(value *string) {
