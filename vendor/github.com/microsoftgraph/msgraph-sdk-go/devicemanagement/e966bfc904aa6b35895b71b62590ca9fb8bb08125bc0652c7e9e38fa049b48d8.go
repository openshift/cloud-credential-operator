...
// AssignedUsersWithUserPrincipalName provides operations to manage the assignedUsers property of the microsoft.graph.cloudPcProvisioningPolicyAssignment entity.
...
func (m *VirtualEndpointProvisioningPoliciesItemAssignmentsCloudPcProvisioningPolicyAssignmentItemRequestBuilder) AssignedUsersWithUserPrincipalName(userPrincipalName *string) *VirtualEndpointProvisioningPoliciesItemAssignmentsItemAssignedUsersWithUserPrincipalNameRequestBuilder {
	return NewVirtualEndpointProvisioningPoliciesItemAssignmentsItemAssignedUsersWithUserPrincipalNameRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, userPrincipalName)
}
