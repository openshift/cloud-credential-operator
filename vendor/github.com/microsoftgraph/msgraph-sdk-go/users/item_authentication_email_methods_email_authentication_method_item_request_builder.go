...
// Patch update a user's email address represented by an emailAuthenticationMethod object. Self-service operations aren't supported.
// returns a EmailAuthenticationMethodable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
//
...
// ToPatchRequestInformation update a user's email address represented by an emailAuthenticationMethod object. Self-service operations aren't supported.
// returns a *RequestInformation when successful
