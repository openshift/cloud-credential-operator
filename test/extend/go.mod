...
require (
	...
	github.com/openshift/origin v1.5.0-alpha.3.0.20251112110258-5c72de0e5029
...
// Required for k8s.io/kubernetes, openshift/origin, and test framework compatibility
// Using openshift/kubernetes fork which includes necessary internal packages
replace (
