module github.com/openshift/cloud-credential-operator/test/extend
...
replace (
	...
	// Ginkgo compatibility: Use OpenShift's ginkgo fork for openshift-tests-extension
	github.com/onsi/ginkgo/v2 => github.com/openshift/onsi-ginkgo/v2 v2.6.1-0.20241205171354-8006f302fd12
	// Local development: Use local cloud-credential-operator module
