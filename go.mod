...
// These are needed for the OTE tests.
replace (
...
// Pin all k8s.io packages to consistent versions to avoid dependency conflicts
replace (
...
require (
	...
	k8s.io/cri-client v0.34.0-alpha.2 // indirect
