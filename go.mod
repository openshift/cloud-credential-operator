...
require (
	...
	github.com/openshift/cloud-credential-operator/test/e2e/extension v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/openshift/origin v1.5.0-alpha.3.0.20260204234139-03700fac7c08 // indirect
