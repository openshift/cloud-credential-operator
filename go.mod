...
require (
	...
	github.com/openshift/cloud-credential-operator/test/e2e v0.0.0
...
require (
	...
	github.com/openshift/origin v1.5.0-alpha.3.0.20251203005656-6264449a6c8b // indirect
...
// Required for k8s.io/kubernetes/test/e2e/framework compatibility
...
// Use local test module
replace github.com/openshift/cloud-credential-operator/test/e2e => ./test/e2e
